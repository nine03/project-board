...
class ArticleControllerTest {
    ...
    public void givenNoting_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        ...
        Long articledId = 1L;
        long totalCount = 1L;
        given(articleService.getArticleWithComments(articledId)).willReturn(createArticleWithCommentsDto());
        given(articleService.getArticleCount()).willReturn(totalCount);

        // When & Then
        mvc.perform(get("/articles/" + articledId))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML))
        ...
        then(articleService).should().getArticleWithComments(articledId);
    ...
    @WithUserDetails(value = "yeongjunTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
